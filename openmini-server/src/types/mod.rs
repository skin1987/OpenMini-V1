...
pub use crate::service::http::types::{
    ApiError, ChatChoice, ChatCompletionChunk, ChatCompletionRequest, ChatCompletionResponse,
    ChatMessage, DeltaChoice, DeltaContent, HealthCheckResponse, ImageUnderstandRequest,
    ImageUnderstandResponse, ModelInfo, SttRequest, SttResponse, TtsRequest, TtsResponse,
    UsageInfo,
};
...
pub use crate::service::grpc::types::{
    ChatRequest, ChatResponse, HealthRequest, HealthResponse, ImageRequest, ImageResponse, Message,
    OmniChatRequest, OmniChatResponse, OmniInput, OmniOutput, SpeechToTextRequest,
    SpeechToTextResponse, TextToSpeechRequest, TextToSpeechResponse, UsageInfo as GrpcUsageInfo,
};

// 错误类型 (排除包含不兼容类型的变体)
pub use crate::error::{
    AppError, ConfigError, EngineError, HardwareError, TrainingError, WorkerError,
};

// 配置类型
pub use crate::config::settings::{
    CoreSettings, DatabaseSettings, GrpcSettings, MemorySettings, ModelSettings, ServerConfig,
    ServerSettings, ThreadPoolSettings, WorkerSettings,
};

// 监控/健康检查类型
pub use crate::monitoring::health_check::{ComponentHealth, HealthCheckerConfig, HealthStatus};

...
COPY Cargo.toml Cargo.lock ./ COPY openmini-server/Cargo.toml ./openmini-server/ COPY openmini-proto/Cargo.toml ./openmini-proto/
...
LABEL maintainer="OpenMini Team" version="1.2.0-beta.1"
...
ENV RUST_LOG=info OPENMINI_CONFIG_PATH=/etc/openmini/server.toml OPENMINI_MODEL_PATH=/data/models
